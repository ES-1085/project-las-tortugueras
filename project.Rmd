...
GTBK_data <- GTBK_data %>%
  mutate(lugar = 
           case_when(
             ...
             # area_de_monitoreo == "region delas grandes Islas del G.C." ~ UNKNOWN,
             # area_de_monitoreo == "A media travesia" ~ UNKNOWN,
             # area_de_monitoreo == "a unos 8 km al Este de la ispm" ~ UNKNOWN,
             # area_de_monitoreo == "Poza La Gallina" ~ UNKNOWN,
             # area_de_monitoreo == "Raya roja" ~ UNKNOWN,
             # area_de_monitoreo == "Mision del sol" ~ UNKOWN,
             # area_de_monitoreo == "Liberada en Islandia Marina" ~ UNKNOWN,
             # area_de_monitoreo == "Mision del Sol" ~ UNKNOWN,
...
GTBK_data <- GTBK_data %>%
  mutate(geografía = 
           case_when(
             ...
             lugar == "Playa" ~ "playa"))
>>>>>>> ff77b56c9ec1863bbcf73de43250acfdf90b3e26
```
...
```{r visualizing-missing-data, include = FALSE}
library(visdat)
library(naniar)
