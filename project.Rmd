...
# GTBK_early <- GTBK_2010_2018 %>% 
#   select(nombre_tortuga, especie, sexo, fecha, estacion, area_de_monitoreo, posicion_lat_long, peso, l_c_c, a_r_c, a_c_c, recaptura, marca_derecha, marca_izquierda)
# 
# GTBK_late <- GTBK_2018_2023 %>% 
#   select(fecha, latitud, longitud)
# 
# GTBK <- full_join(GTBK_early, GTBK_late, by = "fecha")
```
...
visdat::vis_dat(buis_turtle_measures)
```
```{r}
