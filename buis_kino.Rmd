...
```{r GTBK-time-enabled-individual-growth}
#use gganimate to focus in on between 3-5 individual turtles and time enable a geom_point/geom_line graph of their growth
